...
This one doesn't.
This repository is about everything that happens before the first line of code is written.
...
But to understand how it changes the way I think.
The project becomes my laboratory.
...
It is a collection of engineering decisions.
Each lesson starts with a problem.
Then explores different ideas.
Explains why one solution was chosen.
And discusses the trade-offs behind that decision.
